...
class AddListingViewController: UIViewController, UIScrollViewDelegate, IGLDropDownMenuDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITextFieldDelegate {
    ...
    func makeListing() {
        ...
        if (firstImage.image != placeholder && secondImage.image != placeholder && thirdImage.image != placeholder && self.headline.text! != "") && (self.listPrice.text! != "") && (self.shortDescription.text! != "") && (self.dropDownMenu.menuText != "") {
        ...
        }else if  (self.headline.text! == "") || (self.listPrice.text! == "") || (self.shortDescription.text! == "") || (self.dropDownMenu.menuText == "") {
    ...
    override func viewDidLoad() {
        ...
        listPrice.keyboardType = .NumberPad
    ...
    func setupInit() {
        ...
        dropDownMenu.frame = CGRectMake(listingType.bounds.origin.x + 10, 298, self.view.frame.width - 21, 25)
    ...
    func setupCategory() {
        ...
        dropDownMenuTwo.frame = CGRectMake(listingType.bounds.origin.x + 10, 336, self.view.frame.width - 21, 25)
    ...
    func backBtn() {
        ...
        btnName.setImage(UIImage(named: "List-it_0000s_0000_View-Switcher"), forState: .Normal)
